...
<script type="text/javascript">
	...
	var updateUrl = "{{ route('products.update','1') }}";
							...
							<form method="POST" name="myForm" id="myForm"  enctype="multipart/form-data" onsubmit="return form_validation()">
					           ...
					           <div class="form-group row">
						            ...
						            <div class="col-md-3">
						              ...
						              <input type="text" name="price"  class="form-control-sm form-control">
						            </div>
						            ...
						            <div class="col-md-4">
						              ...
						              <input type="text"  name="keyword"  class="form-control-sm form-control">
						            </div>
						            <div class="col-md-4">
					           ...
					           <div class="form-group row">
					            <div class="col-md-4">
					             ...
					             <div class="col-md-4">
									<label class="col-form-label">Booklit File [pdf,docx,png,jpg]</label>
					...
					<div class="card">
						<div class="card-header">Edit <button class='btn btn-primary btn-sm float-right' onclick="$('#editCard').hide()">Close</button></div>
							...
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<div class="card">
									<div class="card-header">products <button class='btn btn-primary btn-sm float-right' onclick="addNew()">Add</button></div>
									<div class="card-body">
											...
											<?php foreach ($data as $row): ?>
											  ...
											  <tr id="row{{ $row->id }} ">
												...
												<td style="padding: 2px;text-align: center;" width="15%">
													...
													<form style="display: none;" id="{{ 'formno'.$row->id }}" action="{{ route('products.destroy',$row->id) }}" method="POST">
														@method('DELETE')
				                                        @csrf
				                                    </form>
