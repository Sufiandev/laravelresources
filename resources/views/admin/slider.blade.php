...
<script type="text/javascript">
	var showUrl = "{{ route('slider.show',':id') }}";
	var updateUrl = "{{ route('slider.update','1') }}";
	var storeUrl = "{{ route('slider.store') }} ";
</script>
	<!-- BEGIN .app-main -->
	<div class="app-main">
							...
							<form method="POST" name="myForm" id="myForm"  enctype="multipart/form-data" onsubmit="return form_validation()">
					           ...
					           <div class="form-group row">
						            ...
						            <div class="col-md-3">
						              ...
						              <input type="text"  name="displayOrder"  class="form-control-sm form-control">
						            </div>
					...
					<div class="card">
						<div class="card-header">Edit <button class='btn btn-primary btn-sm float-right' onclick="$('#editCard').hide()">Close</button></div>
							...
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<div class="card">
									<div class="card-header">slider <button class='btn btn-primary btn-sm float-right' onclick="addNew()">Add</button></div>
									<div class="card-body">
											...
											<?php foreach ($data as $row): ?>
											  ...
											  <tr id="row{{ $row->id }} ">
												...
												<td style="padding: 2px;text-align: center;" width="15%">
													...
													<form style="display: none;" id="{{ 'formno'.$row->id }}" action="{{ route('slider.destroy',$row->id) }}" method="POST">
														@method('DELETE')
				                                        @csrf
				                                    </form>
